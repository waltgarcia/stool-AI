...
# Configuration
class Config:
    data_dir = "data/bristol_stool_dataset"  # Path to your dataset
    img_size = 224
    batch_size = 32
    epochs = 50
    learning_rate = 0.001
    ...
    model_save_path = "models/bristol_classifier.pth"
...
def evaluate_model(model, test_loader, criterion):
    ...
    print("\nClassification Report:")
    target_names = [f'Type {i+1}' for i in range(Config.num_classes)]
